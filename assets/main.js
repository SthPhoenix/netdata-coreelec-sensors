...
function headMain(os, charts, duration) {
    ...
    if(typeof charts['sensors.temp_thermal_zone0_thermal_thermal_zone0'] !== 'undefined') {
                head += '<div class="netdata-container" style="margin-right: 10px;"'
                    + ' data-netdata="sensors.temp_thermal_zone0_thermal_thermal_zone0"'
                    + ' data-dimensions="temp"'
                    + ' data-chart-library="easypiechart"'
                    + ' data-title="Temperature"'
                    + ' data-units="Celsius"'
                    + ' data-easypiechart-max-value="90"'
                    + ' data-width="11%"'
